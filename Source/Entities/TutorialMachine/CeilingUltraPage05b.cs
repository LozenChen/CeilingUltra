...
public class CeilingUltraPage05b : CeilingUltraPage {
    ...
    public override void Added(CeilingUltraPresentation presentation) {
        ...
        displays.Add(new Display(new Vector2((float)base.Width * 0.28f, base.Height - 600), Dialog.Get("CEILING_ULTRA_PAGE5B_INFO1"), "ceiling_too_far", new Vector2(-50f, 20f), new Vector2(1f, -1f)).Apply(x => x.texture = texture));
        displays.Add(new Display(new Vector2((float)base.Width * 0.72f, base.Height - 600), Dialog.Get("CEILING_ULTRA_PAGE5B_INFO2"), "ceiling_too_late", new Vector2(-50f, 20f), new Vector2(1f, -1f)).Apply(x => x.texture = texture));
    }
    ...
    public override void Render() {
        ActiveFont.DrawOutline(Dialog.Clean("CEILING_ULTRA_PAGE5B_TITLE"), new Vector2(128f, 100f), Vector2.Zero, Vector2.One * 1.5f, Color.White, 2f, Color.Black);
        foreach (Display display in displays) {
            display.Render();
        }
    }
