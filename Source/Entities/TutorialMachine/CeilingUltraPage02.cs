...
public class CeilingUltraPage02 : CeilingUltraPage {
    ...
    public override IEnumerator Routine() {
        string[] text = Dialog.Clean("CEILING_ULTRA_PAGE2_TITLE").Split(new char[1] { '|' });
        ...
        list = FancyText.Parse(Dialog.Get("CEILING_ULTRA_PAGE2_LIST"), Width, 32, 1f, Color.Black * 0.7f);
        float delay = 0f;
    ...
    public override void Render() {
        ...
        if (impossibleEase > 0f) {
            ...
            ActiveFont.Draw(Dialog.Clean("CEILING_ULTRA_PAGE2_IMPOSSIBLE"), Vector2.Zero, new Vector2(0.5f, 0.5f), Vector2.One * (2f + (1f - impossibleEase) * 0.5f), Color.Black * impossibleEase);
            Draw.SpriteBatch.End();
