...
moveBlock.name = "CeilingUltra/MoveBlockOnDashCollide"
...
moveBlock.placements = {
    name = "Move Block On DashCollide",
    data = {
        width = 16,
        height = 16,
        direction = "Right",
...
moveBlock.fieldOrder = {"x", "y", "width", "height", "direction", "canSteer", "fast", "ActivateOnDashCollide"}
